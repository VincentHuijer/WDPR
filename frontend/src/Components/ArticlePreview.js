...
export default function ArticlePreview({text, overonspagina = false}) {
    return (
        <div className="w-11/12 flex flex-col md:flex-row justify-between m-auto mt-12 h-full">
            <div className='h-fit pb-1.5 flex flex-col justify-between'>
                <p className="text-2xl lg:text-4xl font-extrabold">OVER THEATER LAAK</p>
