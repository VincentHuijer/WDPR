            ...
            <div className='w-11/12 flex justify-between items-center m-auto pb-2'>
                        ...
                        accesToken == "none" ?
                            ...
                            <div className='flex items-center gap-2'>
                                <div className='relative'>
                                    <svg className='cursor-pointer' name="profielpoppertje" onClick={() => { setOpenSettings(!openSettings) }} width="35" height="35" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {openSettings && <div className='absolute mt-3 py-2 pb-4 bg-white border-black border-2 rounded-2xl w-72 float-right right-0'>
                                        ...
                                        <div className='flex flex-col divide-y-2 px-4 mt-4 divide-black font-semibold'>
                                            ...
                                            {/* ADMIN PAGES */}
                                            {(userData.rolNaam == "Admin") && <Link className='cursor-pointer' to="/admin/medewerkers">Medewerker Portaal</Link>}
                                            {(userData.rolNaam == "Admin") && <Link className='cursor-pointer' to="/medewerker">Voorstelling Portaal</Link>}
                                            {(userData.rolNaam == "Admin") && <Link className='cursor-pointer' to="/admin/groepen">Groepen Portaal</Link>}
                ...
                <nav className='block lg:hidden'>
                    <svg onClick={() => setOpenMobileNav(!openMobileNav)} width="35" height="35" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.1875 76.5625H82.8125M17.1875 51.5625H82.8125M17.1875 26.5625H82.8125" stroke="#2E2E38" strokeWidth="9.375" strokeLinecap="round" strokeLinejoin="round" name="mobileButton" />
                    </svg>
                </nav>
            </div>
